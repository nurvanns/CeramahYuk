...
<body>
	<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
	  ...
	  <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
		  <div class="container-fluid">          
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
					  <a class="nav-link" aria-current="page" href="\dataceramah">Data Ceramah</a>
					</li>
					<li class="nav-item">
					  <a class="nav-link active" aria-current="page" href="\datapenceramah">Data Penceramah</a>
					</li>
					<li class="nav-item">
		...
		<div class="container">		
			<h3>Data Penceramah</h3><br> 
			<button type="button" class="btn btn-info btn-sm"><a class="text-dark" href="/datapenceramah/tambah"> + Tambah Penceramah</a></button>
		</div>
	...
	<div class="container">
		<table class="table table-bordered" border="2">
			...
			<tr>
				<td>{{ $p->nama_penceramah }}</td>
				<td>{{ $p->jenis_kelamin }}</td>
				<td>{{ $p->no_telepon }}</td>
				<td>{{ $p->alamat }}</td>
				<td>{{ $p->tarif }}</td>
				<td>
                    <button type="button" class="btn btn-info btn-sm"><a class="text-dark" href="/datapenceramah/edit/{{ $p->id_penceramah }}">Edit</a></button>
                    |
                    <button type="button" class="btn btn-danger btn-sm"><a class="text-light" href="/datapenceramah/hapus/{{ $p->id_penceramah }}">Hapus</a></button>
                </td>
			</tr>
			@endforeach
		</table>
